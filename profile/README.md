...
The platform features a series of custom models, called MUSA (Mansa's Unsupervised Stocks Analyst) trained on robust datasets and algorithms related to the Brazilian Stock Market and economics. Our system analyzes market patterns and trends, builds and manages the portfolio and gives an in-depth analysis through our MUSA models, like the Aladdin system by BlackRock, Inc.
